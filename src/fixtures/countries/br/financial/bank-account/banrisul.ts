/** Valid Banrisul account formats (XXXX XXXXXXXXX-D) */
export const validBankAccountBanrisul = {
...
/** Invalid Banrisul account strings */
export const invalidBankAccountBanrisul = {
