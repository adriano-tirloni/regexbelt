/** Valid Santander account formats (XXXX XXXXXXXX-D) */
export const validBankAccountSantander = {
...
/** Invalid Santander account strings */
export const invalidBankAccountSantander = {
